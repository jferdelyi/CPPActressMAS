...
*/
            namespace dtoa_impl {
                ...
                struct diyfp // f * 2^e
                {
                    ...
                    */
                    static diyfp normalize_to(const diyfp &x, int target_exponent) noexcept {
                        int delta = x.e - target_exponent;
...
*/
                ...
                boundaries compute_boundaries(FloatType value) {
                    ...
                    bool lower_boundary_is_closer = F == 0 && E > 1;
...
*/
                inline cached_power get_cached_power_for_binary_exponent(int e) {
                    ...
                    int index = (-kCachedPowersMinDecExp + k + (kCachedPowersDecStep - 1)) / kCachedPowersDecStep;
                    JSON_ASSERT(index >= 0);
...
*/
                inline void grisu2_digit_gen(char *buffer, int &length, int &decimal_exponent,
                    ...
                    std::uint32_t pow10{};
                    int k = find_largest_pow10(p1, pow10);
