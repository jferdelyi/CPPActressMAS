...
*/
            ...
            public:
                ...
                void write_msgpack(const BasicJsonType &j) {
                    switch (j.type()) {
                        ...
                        case value_t::binary: {
                            ...
                            bool use_ext = j.m_value.binary->has_subtype();
                ...
                */
                void write_ubjson(const BasicJsonType &j, bool use_count,
                                  bool use_type, bool add_prefix = true,
                                  bool use_bjdata = false) {
                    switch (j.type()) {
                        case value_t::null: {
                            if (add_prefix) {
                        ...
                        case value_t::array: {
                            ...
                            if (use_type && !j.m_value.array->empty()) {
                                ...
                                bool same_prefix = std::all_of(j.begin() + 1, j.end(),
                        ...
                        case value_t::object: {
                            ...
                            if (use_type && !j.m_value.object->empty()) {
                                JSON_ASSERT(use_count);
                                const CharType first_prefix = ubjson_prefix(j.front(), use_bjdata);
                                bool same_prefix = std::all_of(j.begin(), j.end(),
                                                                     [this, first_prefix, use_bjdata](
                                                                             const BasicJsonType &v) {
                                                                         return ubjson_prefix(v, use_bjdata) ==
                                                                                first_prefix;
            ...
            private:
                ...
                */
                CharType ubjson_prefix(const BasicJsonType &j, bool use_bjdata) const noexcept {
                    switch (j.type()) {
                        case value_t::null:
                            return 'Z';
                ...
                */
                bool write_bjdata_ndarray(const typename BasicJsonType::object_t &value, bool use_count,
                                          bool use_type) {
                ...
                */
                ...
                void write_number(const NumberType n, bool OutputIsLittleEndian = false) {
...
#pragma GCC diagnostic pop
            ...
            private:
                ...
                bool is_little_endian = little_endianness();
