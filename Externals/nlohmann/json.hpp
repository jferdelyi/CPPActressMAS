    ...
    basic_json* m_parent = nullptr;
        ...
        public:
            ...
            static void to_ubjson(const basic_json &j, detail::output_adapter<std::uint8_t> o,
                                  bool use_size = false, bool use_type = false) {
            ...
            static basic_json from_cbor(InputType &&i,
                ...
                auto ia = detail::input_adapter(std::forward<InputType>(i));
                bool res = binary_reader<decltype(ia)>(std::move(ia), input_format_t::cbor).sax_parse(
            ...
            static basic_json from_msgpack(InputType &&i,
                ...
                detail::json_sax_dom_parser<basic_json> sdp(result, allow_exceptions);
                auto ia = detail::input_adapter(std::forward<InputType>(i));
                bool res = binary_reader<decltype(ia)>(std::move(ia), input_format_t::msgpack).sax_parse(
            ...
            static basic_json from_ubjson(InputType &&i,
                ...
                detail::json_sax_dom_parser<basic_json> sdp(result, allow_exceptions);
                auto ia = detail::input_adapter(std::forward<InputType>(i));
                bool res = binary_reader<decltype(ia)>(std::move(ia), input_format_t::ubjson).sax_parse(
            ...
            static basic_json from_bjdata(InputType &&i,
                ...
                detail::json_sax_dom_parser<basic_json> sdp(result, allow_exceptions);
                auto ia = detail::input_adapter(std::forward<InputType>(i));
                bool res = binary_reader<decltype(ia)>(std::move(ia), input_format_t::bjdata).sax_parse(
            ...
            static basic_json from_bson(InputType &&i,
                ...
                detail::json_sax_dom_parser<basic_json> sdp(result, allow_exceptions);
                auto ia = detail::input_adapter(std::forward<InputType>(i));
                bool res = binary_reader<decltype(ia)>(std::move(ia), input_format_t::bson).sax_parse(
